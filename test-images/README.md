...
Local card imagery for development and accuracy runs. **Everything in this folder except this README is gitignored** and must never be committed — card artwork is Wizards of the Coast IP regardless of who photographed it (see `docs/DECISIONS.md`).
